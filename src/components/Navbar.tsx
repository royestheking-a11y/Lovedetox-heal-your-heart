            ...
            <div className="max-w-7xl mx-auto px-6 py-4">
                <div className="flex items-center justify-between">
                    ...
                    <div className="hidden md:flex items-center gap-3">
                        {user ? (
                            <Link to={user.isAdmin ? "/admin" : "/dashboard"} className="btn-primary">
                ...
                {mobileMenuOpen && (
                    <div className="md:hidden mt-4 pb-4 space-y-3 animate-in slide-in-from-top duration-300">
                        ...
                        <div className="pt-3 border-t border-gray-200 dark:border-gray-700 space-y-2">
                            {user ? (
                                <Link to={user.isAdmin ? "/admin" : "/dashboard"} onClick={() => setMobileMenuOpen(false)} className="block w-full btn-primary text-center">
                                    {user.isAdmin ? "Admin Panel" : "Dashboard"}
                                </Link>
                            ) : (
                                <>
